...
public sealed record SubMysteryGiftAlertPlayingMessage : AlertPlayingMessage, IHasPayload<SubMysteryGiftPayload>
{
    ...
    public required SubMysteryGiftPayload Payload { get; init; }
